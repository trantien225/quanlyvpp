...
// Dinh dang lai hien thi thong tin ngay gio ra man hinh
    ...
    private void btnThem_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThem_ActionPerformed
        ...
        SDT = txtSDT.getText();
        LoaiKhachHang =NHOM_08.nhom_08.frmTC.GetCbbSelected(cbbLoaiKhachHang);
        ...
        if (kiemtra) {
           ...
           NHOM_08.nhom_08.frmTC.layDuLieuKhachHang();
           NHOM_08.nhom_08.frmTC.SetCbbKhachHangfrm(txtTenKhachHang.getText());
...
public boolean KiemTraNhapKhachHang(int ts) {
        ...
        if (ThongBao.equals("")) {
            ...
            kiemtra = false;
            NHOM_08.nhom_08.frmTC.ThongBao(ThongBao, "lỗi nhập liệu", 2);
        }
        return kiemtra;
    }
...
int tam=0;
    ...
    private void jPanel_KhachHangComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel_KhachHangComponentShown
        ...
        NHOM_08.nhom_08.frmTC.layDuLieuKhachHang();
        cbbLoaiKhachHang.setModel(  NHOM_08.nhom_08.frmTC.LayDuLieucbb("LoaiKhachHang", "TenLoaiKhachHang", "MaLoaiKhachHang"));
        for (int i = 1; i < 32; i++) {
            cbbNgay.addItem(String.valueOf(i));
        }
        for (int i = 1; i < 13; i++) {
