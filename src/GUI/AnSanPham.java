 ...
 * @author huy
 */
public class AnSanPham extends javax.swing.JFrame {
    ...
    private void btnAnSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnSanPhamActionPerformed
      String MaSanPham,  TrangThai ;
        MaSanPham = NHOM_08.nhom_08.frmTC.GetMaSanPham();
    ...
    private void btnXoaSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaSanPhamActionPerformed
             ...
             if(! NHOM_08.nhom_08.frmTC.GetMaSanPham().equals("")){
        NHOM_08.nhom_08.frmTC.XoaSanPham();
       NHOM_08.nhom_08.frmTC.ResSanPham();
}
else
     NHOM_08.nhom_08.frmTC.ThongBao("bạn chưa nhập mã sản phẩm", "lỗi khi xóa",2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnSanPham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
