...
import static NHOM_08.nhom_08.connection;
...
public class DangNhap extends javax.swing.JFrame {
    ...
    public DangNhap() {
        ...
        File file = new File("Luutaikhoan.txt");
        ...
        if (!tendangnhap.equals("")) {
            ...
            System.out.println("Checked Luu Tai khoan");
        } else {
            System.out.println("Khong Luu Tai Khoan");
        }
    }
    ...
    private void btnDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangNhapActionPerformed
        ...
        nhapTK = txtUserName.getText().trim();
        nhapMK = txtPassword.getText().trim();
//        String strUsername = txtUserName.getText().trim();
//        String strPassword = String.valueOf(txtPassword.getPassword()).trim();
        String cautruyvan = "select * from Users where TenDangNhap= '" + nhapTK + "' and Password= '" + nhapMK + "'";
        ...
        if (chkbNhoMatKhau.isSelected()) {
            luutdn = nhapTK;
            luumk = nhapMK;
            System.out.println("Luu Tai Khoan");
        } else {
            luutdn = "";
            luumk = "";
        ...
        try {
            ...
            bw.close();
            if (chkbNhoMatKhau.isSelected()) {
                JOptionPane.showMessageDialog(this, "Đã lưu tài khoản cho lần đăng nhập tiếp theo");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }

        if (KiemTra(nhapTK, nhapMK)) {
            NHOM_08.nhom_08.frmTC.show();
            this.dispose();
        }
        else if (KiemTra1(nhapTK, nhapMK)) {
            NHOM_08.nhom_08.frmCH.show();
            this.dispose();
        } else {
    ...
    private boolean KiemTra(String tdn, String mk) {
        boolean kq = false;
        String cautruyvan = "select * from Users where TenDangNhap= '" + tdn + "' and Password= '" + mk + "' and Quyen='1'";
    ...
    private boolean KiemTra1(String tdn, String mk) {
        boolean kq = false;
        String cautruyvan = "select * from Users where TenDangNhap= '" + tdn + "' and Password= '" + mk + "' and Quyen='2'";
        //System.out.println(cautruyvan);
        ResultSet rs = NHOM_08.nhom_08.connection.ExcuteQueryGetTable(cautruyvan);
        try {
            if (rs.next()) {
