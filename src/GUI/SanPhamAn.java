...
public class SanPhamAn extends javax.swing.JFrame {
    ...
    private void tblSanPham_spaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPham_spaMouseClicked
        ...
        NHOM_08.nhom_08.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 3).toString(), cbbMaLoaiSanPham_SanPhamAn);
        NHOM_08.nhom_08.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 6).toString(), cbbHangSanXuat_SanPhamAn);
    ...
    private void jPanelSanPham_spaComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanelSanPham_spaComponentShown
       LayDuLieuSanPham("0");
        ...
        cbbMaLoaiSanPham_SanPhamAn.setModel(NHOM_08.nhom_08.frmTC.LayDuLieucbb("LoaiSanPham", "TenLoaiSanPham", "MaLoaiSanPham"));
        cbbHangSanXuat_SanPhamAn.setModel(NHOM_08.nhom_08.frmTC.LayDuLieucbb("HangSanXuat", "TenHangSanXuat", "MaHangSanXuat"));
    ...
    private void btnHienlai_SanPhamAnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHienlai_SanPhamAnActionPerformed
        ...
        if (kiemtra) {
            ...
            NHOM_08.nhom_08.frmTC.ThongBao("Không thể ", "Sửa Sản Phẩm", 2);
        }
      LayDuLieuSanPham("0");
      ResSanPham();
      NHOM_08.nhom_08.frmTC.LayDuLieuSanPham("1");
